    ...
    return {
      ...
      onCodePathEnd: function(codePath, codePathNode) {
        ...
        var isDirectlyInsideComponentOrHook = codePathFunctionName
          ...
          : false; // Compute the earliest finalizer level using information from the
          ...
          for (
            ...
            var possiblyHasEarlyReturn =
              segment.nextSegments.length === 0
                ...
                : shortestFinalPathLength < shortestPathLengthToStart(segment); // Count all the paths from the start of our code path to the end of
            ...
            var pathsFromStartToEnd =
              countPathsFromStart(segment) * countPathsToEnd(segment); // Is this hook a part of a cyclic segment?
...
function fastFindReferenceWithParent(start, target) {
  ...
  while (queue.length) {
    ...
    for (
      var _i4 = 0, _Object$entries = Object.entries(item);
