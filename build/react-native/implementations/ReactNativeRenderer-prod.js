        ...
        switch (current.tag) {
          ...
          case 5:
            ...
            if (null !== current$jscomp$0 && null != current.stateNode)
              ...
              type = new ReactNativeFiberHostComponent(newProps, type);
              instanceCache.set(newProps, renderExpirationTime);
              instanceProps.set(newProps, current$jscomp$0);
              current$jscomp$0 = type;
              appendAllChildren(current$jscomp$0, current, !1, !1);
              finalizeInitialChildren(current$jscomp$0) &&
                (current.effectTag |= 4);
          ...
          case 6:
            if (current$jscomp$0 && null != current.stateNode)
              ...
              if (!renderExpirationTime.isInAParentText)
                throw ReactError(
                  Error(
              ...
              instanceCache.set(renderExpirationTime, current);
              current$jscomp$0.stateNode = renderExpirationTime;
            }
            break;
          case 11:
            break;
...
var ReactNativeRenderer$1 = { default: ReactNativeRenderer },
