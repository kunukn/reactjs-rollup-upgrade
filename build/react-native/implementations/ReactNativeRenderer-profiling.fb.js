...
var injectedNamesToPlugins$jscomp$inline_101 = {
  ...
  isOrderingDirty$jscomp$inline_102 = !1,
  pluginName$jscomp$inline_103;
for (pluginName$jscomp$inline_103 in injectedNamesToPlugins$jscomp$inline_101)
  if (
    injectedNamesToPlugins$jscomp$inline_101.hasOwnProperty(
      pluginName$jscomp$inline_103
    )
  ) {
    var pluginModule$jscomp$inline_104 =
      injectedNamesToPlugins$jscomp$inline_101[pluginName$jscomp$inline_103];
    if (
      !namesToPlugins.hasOwnProperty(pluginName$jscomp$inline_103) ||
      namesToPlugins[pluginName$jscomp$inline_103] !==
        pluginModule$jscomp$inline_104
    ) {
      if (namesToPlugins[pluginName$jscomp$inline_103])
        throw Error(
      ...
      isOrderingDirty$jscomp$inline_102 = !0;
    }
  }
isOrderingDirty$jscomp$inline_102 && recomputePluginOrdering();
