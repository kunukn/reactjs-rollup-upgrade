    ...
    if (isHost) {
      ...
      if (parentFiber) {
        ...
        var beforeChild = parentFiber,
          index = isHost.children.indexOf(stateNode);
        -1 !== index && isHost.children.splice(index, 1);
        beforeChild = isHost.children.indexOf(beforeChild);
        isHost.children.splice(beforeChild, 0, stateNode);
      } else
        (isHost = parent),
          (beforeChild = isHost.children.indexOf(stateNode)),
          -1 !== beforeChild && isHost.children.splice(beforeChild, 1),
          isHost.children.push(stateNode);
    } else if (4 !== node.tag && null !== node.child) {
      node.child.return = node;
      node = node.child;
      continue;
    ...
    case 13:
      ...
      if (null !== current)
        a: for (type = current; ; ) {
          ...
          else if (6 === type.tag) type.stateNode.isHidden = newProps ? !0 : !1;
          else if (
            13 === type.tag &&
        ...
        switch (current.tag) {
          ...
          case 6:
            if (current$jscomp$0 && null != current.stateNode)
              ...
              requiredContext(rootInstanceStackCursor.current);
              requiredContext(contextStackCursor$1.current);
              current.stateNode = { text: newProps, isHidden: !1, tag: "TEXT" };
            }
            break;
          case 11:
            break;
...
module.exports = ReactTestRenderer$1.default || ReactTestRenderer$1;
