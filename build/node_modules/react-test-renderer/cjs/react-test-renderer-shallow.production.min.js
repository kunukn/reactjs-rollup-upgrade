...
case D:return G(b.type);case E:if(b=1===b._status?b._result:null)return G(b)}return null}function H(b,d){return b===d&&(0!==b||1/b===1/d)||b!==b&&d!==d}var I=Object.prototype.hasOwnProperty;function J(b,d){if(H(b,d))return!0;if("object"!==typeof b||null===b||"object"!==typeof d||null===d)return!1;var a=Object.keys(b),c=Object.keys(d);if(a.length!==c.length)return!1;for(c=0;c<a.length;c++)if(!I.call(d,a[c])||!H(b[a[c]],d[a[c]]))return!1;return!0}
var K=F.ReactCurrentDispatcher,L={},M=function(){function b(a){this._renderer=a;this._callbacks=[]}var d=b.prototype;d._enqueueCallback=function(a,c){"function"===typeof a&&c&&this._callbacks.push({callback:a,publicInstance:c})};d._invokeCallbacks=function(){var a=this._callbacks;this._callbacks=[];a.forEach(function(a){a.callback.call(a.publicInstance)})};d.isMounted=function(){return!!this._renderer._element};d.enqueueForceUpdate=function(a,c){this._enqueueCallback(c,a);this._renderer._forcedUpdate=
...
null,this._numberOfReRenders=0)};d.getMountedInstance=function(){return this._instance};d.getRenderOutput=function(){return this._rendered};d.render=function(a){var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:L;if(!m.isValidElement(a))throw q(Error(12),"function"===typeof a?" Instead of passing a component class, make sure to instantiate it by passing it to React.createElement.":"");if("string"===typeof a.type)throw q(Error(13),a.type);if(!n.isForwardRef(a)&&"function"!==typeof a.type&&
!n.isMemo(a.type))throw q(Error(249),Array.isArray(a.type)?"array":null===a.type?"null":typeof a.type);if(!this._rendering){null!=this._element&&this._element.type!==a.type&&this._reset();var b=n.isMemo(a.type)?a.type.type:a.type,d=this._element;this._rendering=!0;this._element=a;var g;if((g=b.contextTypes)&&c){var l={},h;for(h in g)l[h]=c[h];g=l}else g=L;this._context=g;n.isMemo(a.type)&&b.propTypes&&(P=a,p(b.propTypes,a.props,"prop",G(b),Q));if(this._instance)this._updateClassComponent(b,a,this._context);
else if(b.prototype&&b.prototype.isReactComponent)this._instance=new b(a.props,this._context,this._updater),"function"===typeof b.getDerivedStateFromProps&&(c=b.getDerivedStateFromProps.call(null,a.props,this._instance.state),null!=c&&(this._instance.state=k({},this._instance.state,c))),b.contextTypes&&(P=a,c=(c=this._instance)&&c.constructor,p(b.contextTypes,this._context,"context",b.displayName||c&&c.displayName||b.name||c&&c.name||null,Q),P=null),this._mountClassComponent(b,a,this._context);else if(g=
!0,n.isMemo(a.type)&&null!==d&&(a.type.compare||J)(d.props,a.props)&&(g=!1),g){d=K.current;K.current=this._dispatcher;try{if(b.$$typeof===n.ForwardRef){if("function"!==typeof b.render)throw q(Error(322),typeof b.render);this._rendered=b.render.call(void 0,a.props,a.ref)}else this._rendered=b(a.props,this._context)}finally{K.current=d}this._finishHooks(a,c)}this._rendering=!1;this._updater._invokeCallbacks();return this.getRenderOutput()}};d.unmount=function(){this._instance&&"function"===typeof this._instance.componentWillUnmount&&
...
this._instance.componentWillMount(),"function"===typeof this._instance.UNSAFE_componentWillMount&&this._instance.UNSAFE_componentWillMount()),b!==this._newState&&(this._instance.state=this._newState||L);this._rendered=this._instance.render()};d._updateClassComponent=function(a,b,d){b=b.props;var c=this._instance.state||L,e=this._instance.props;e!==b&&"function"!==typeof a.getDerivedStateFromProps&&"function"!==typeof this._instance.getSnapshotBeforeUpdate&&("function"===typeof this._instance.componentWillReceiveProps&&
...
(h=!J(e,b)||!J(c,l));h&&"function"!==typeof a.getDerivedStateFromProps&&"function"!==typeof this._instance.getSnapshotBeforeUpdate&&("function"===typeof this._instance.componentWillUpdate&&this._instance.componentWillUpdate(b,l,d),"function"===typeof this._instance.UNSAFE_componentWillUpdate&&this._instance.UNSAFE_componentWillUpdate(b,l,d));this._instance.context=d;this._instance.props=b;this._instance.state=l;this._newState=null;h&&(this._rendered=this._instance.render())};return b}();
R.createRenderer=function(){return new R};var P=null;function S(b){if(null==b)return"#empty";if("string"===typeof b||"number"===typeof b)return"#text";if("string"===typeof b.type)return b.type;b=n.isMemo(b.type)?b.type.type:b.type;return b.displayName||b.name||"Unknown"}function Q(){var b="";if(P){var d=S(P),a=P._owner,c=P._source;a=a&&G(a.type);var e="";c?e=" (at "+c.fileName.replace(r,"")+":"+c.lineNumber+")":a&&(e=" (created by "+a+")");b+="\n    in "+(d||"Unknown")+e}return b}
var T={"default":R},U=T&&T["default"]||T;module.exports=U.default||U;
