...
var ReactCurrentDispatcher = ReactSharedInternals.ReactCurrentDispatcher,
  ...
  Updater = (function() {
    ...
    _proto.isMounted = function() {
      return !!this._renderer._element;
    };
    _proto.enqueueForceUpdate = function(publicInstance, callback) {
    ...
    _proto.enqueueSetState = function(publicInstance, partialState, callback) {
      this._enqueueCallback(callback, publicInstance);
...
var ReactShallowRenderer = (function() {
  ...
  _proto2._validateCurrentlyRenderingComponent = function() {
    if (!this._rendering || this._instance) throw ReactErrorProd(Error(321));
  };
  _proto2._createDispatcher = function() {
    ...
    function useReducer(reducer, initialArg, init) {
      ...
      if (_this2._isReRender) {
        ...
        if (0 < _this2._numberOfReRenders) {
          if (null !== _this2._renderPhaseUpdates) {
            var firstRenderPhaseUpdate = _this2._renderPhaseUpdates.get(init);
      ...
      reducer = workInProgressHook.queue = { first: null, dispatch: null };
      reducer = reducer.dispatch = _this2._dispatchAction.bind(_this2, reducer);
  ...
  _proto2.render = function(element) {
    ...
    if (!this._rendering) {
      ...
      if ((JSCompiler_inline_result = elementType.contextTypes) && context) {
      ...
      if (this._instance)
      ...
      else if (elementType.prototype && elementType.prototype.isReactComponent)
        (this._instance = new elementType(
          ...
          elementType.contextTypes &&
            ((currentlyValidatingElement = element),
            (context = (context = this._instance) && context.constructor),
            checkPropTypes(
              elementType.contextTypes,
              this._context,
              "context",
    ...
    this._forcedUpdate
      ...
      : "function" === typeof this._instance.shouldComponentUpdate
        ...
        : elementType.prototype &&
          ...
          (partialState =
            !shallowEqual(oldProps, element) || !shallowEqual(oldState, state));
    partialState &&
      "function" !== typeof elementType.getDerivedStateFromProps &&
      "function" !== typeof this._instance.getSnapshotBeforeUpdate &&
...
function getDisplayName(element) {
  ...
  element = reactIs.isMemo(element.type) ? element.type.type : element.type;
  return element.displayName || element.name || "Unknown";
}
function getStackAddendum() {
  ...
  if (currentlyValidatingElement) {
    var name = getDisplayName(currentlyValidatingElement),
      ...
      source = currentlyValidatingElement._source;
    ...
    source
      ? (sourceInfo =
          ...
          source.lineNumber +
          ")")
      : owner && (sourceInfo = " (created by " + owner + ")");
    stack += "\n    in " + (name || "Unknown") + sourceInfo;
  }
  return stack;
}
var ReactShallowRenderer$1 = { default: ReactShallowRenderer },
  ReactShallowRenderer$2 =
    (ReactShallowRenderer$1 && ReactShallowRenderer$1["default"]) ||
    ReactShallowRenderer$1;
module.exports = ReactShallowRenderer$2.default || ReactShallowRenderer$2;
