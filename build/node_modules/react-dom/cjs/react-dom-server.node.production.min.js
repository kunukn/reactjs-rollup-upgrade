...
var ReactMarkupReadableStream = (function(_Readable) {
    function ReactMarkupReadableStream(element, makeStaticMarkup) {
      var _this = _Readable.call(this, {}) || this;
    ...
    _proto._destroy = function(err, callback) {
  ...
  ReactDOMServerNode$1 = {
    default: {
      ...
      renderToNodeStream: function(element) {
        return new ReactMarkupReadableStream(element, !1);
      },
      renderToStaticNodeStream: function(element) {
        return new ReactMarkupReadableStream(element, !0);
      },
      version: "16.8.6"
    }
  },
  ReactDOMServer =
    (ReactDOMServerNode$1 && ReactDOMServerNode$1["default"]) ||
    ReactDOMServerNode$1;
