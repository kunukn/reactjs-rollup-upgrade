...
function G(a){if(E[a])return E[a];if(!D[a])return a;var b=D[a],c;for(c in b)if(b.hasOwnProperty(c)&&c in F)return E[a]=b[c];return a}var aa=G("animationend"),ba=G("animationiteration"),ca=G("animationstart"),da=G("transitionend"),H;try{var ea=("require"+Math.random()).slice(0,7);H=(module&&module[ea])("timers").setImmediate}catch(a){H=function(b){var c=new MessageChannel;c.port1.onmessage=b;c.port2.postMessage(void 0)}}
var fa=H,I=m.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,ha=I[11],J=I[12],ia=m.unstable_batchedUpdates,K=q.IsSomeRendererActing,L="function"===typeof n.unstable_flushAllWithoutAsserting,M=n.unstable_flushAllWithoutAsserting||function(){for(var a=!1;ha();)a=!0;return a};function N(a){try{M(),fa(function(){M()?N(a):a()})}catch(b){a(b)}}var O=0,P=!1,ja=m.findDOMNode,Q=m.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,ka=Q[0],R=Q[4],la=Q[5],ma=Q[6],na=Q[7],oa=Q[8],S=Q[9],pa=Q[10];
function T(){}var U=!1;function qa(a,b){if(!a)return[];a=u(a);if(!a)return[];for(var c=a,e=[];;){if(5===c.tag||6===c.tag||1===c.tag||0===c.tag){var d=c.stateNode;b(d)&&e.push(d)}if(c.child)c.child.return=c,c=c.child;else{if(c===a)return e;for(;!c.sibling;){if(!c.return||c.return===a)return e;c=c.return}c.sibling.return=c.return;c=c.sibling}}}
...
b){return W.isCompositeComponent(a)?a._reactInternalFiber.type===b:!1},findAllInRenderedTree:function(a,b){V(a,"findAllInRenderedTree");return a?qa(a._reactInternalFiber,b):[]},scryRenderedDOMComponentsWithClass:function(a,b){V(a,"scryRenderedDOMComponentsWithClass");return W.findAllInRenderedTree(a,function(a){if(W.isDOMComponent(a)){var c=a.className;"string"!==typeof c&&(c=a.getAttribute("class")||"");var d=c.split(/\s+/);if(!Array.isArray(b)){if(void 0===b)throw p(Error(11));b=b.split(/\s+/)}return b.every(function(a){return-1!==
...
a.length+") for componentType:"+b);return a[0]},mockComponent:function(a,b){U||(U=!0);b=b||a.mockTagName||"div";a.prototype.render.mockImplementation(function(){return k.createElement(b,null,this.props.children)});return this},nativeTouchData:function(a,b){return{touches:[{pageX:a,pageY:b}]}},Simulate:null,SimulateNative:{},act:function(a){function b(){O--;K.current=c;J.current=e}!1===P&&(P=!0,console.error("act(...) is not supported in production builds of React, and might not behave as expected."));
O++;var c=K.current;var e=J.current;K.current=!0;J.current=!0;try{var d=ia(a)}catch(f){throw b(),f;}if(null!==d&&"object"===typeof d&&"function"===typeof d.then)return{then:function(a,e){d.then(function(){1<O||!0===L&&!0===c?(b(),a()):N(function(c){b();c?e(c):a()})},function(a){b();e(a)})}};try{1!==O||!1!==L&&!1!==c||M(),b()}catch(f){throw b(),f;}return{then:function(a){a()}}}};
function ra(a){return function(b,c){if(k.isValidElement(b))throw p(Error(228));if(W.isCompositeComponent(b))throw p(Error(229));var e=R[a],d=new T;d.target=b;d.type=a.toLowerCase();var f=ka(b),h=new x(e,f,d,b);h.persist();g(h,c);e.phasedRegistrationNames?la(h):ma(h);m.unstable_batchedUpdates(function(){na(b);pa(h)});oa()}}W.Simulate={};for(var X in R)W.Simulate[X]=ra(X);
function sa(a,b){return function(c,e){var d=new T(a);g(d,e);W.isDOMComponent(c)?(c=ja(c),d.target=c,S(b,1,d)):c.tagName&&(d.target=c,S(b,1,d))}}
...
["touchstart","touchStart"],[da,"transitionEnd"],["volumechange","volumeChange"],["waiting","waiting"],["wheel","wheel"]].forEach(function(a){var b=a[1];W.SimulateNative[b]=sa(b,a[0])});var Y={"default":W},Z=Y&&Y["default"]||Y;module.exports=Z.default||Z;
