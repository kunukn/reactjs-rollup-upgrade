...
var enqueueTask$1 = enqueueTask,
  ...
  flushWork =
    ...
    function() {
      for (var didFlushWork = !1; flushPassiveEffects$1(); ) didFlushWork = !0;
      return didFlushWork;
    };
...
function findAllInRenderedFiberTreeInternal(fiber, test) {
  ...
  for (var node = fiber, ret = []; ; ) {
    if (5 === node.tag || 6 === node.tag || 1 === node.tag || 0 === node.tag) {
...
var ReactTestUtils = {
  ...
  findRenderedDOMComponentWithClass: function(root, className) {
    ...
    root = ReactTestUtils.scryRenderedDOMComponentsWithClass(root, className);
    if (1 !== root.length)
      throw Error(
  ...
  findRenderedComponentWithType: function(root, componentType) {
    ...
    root = ReactTestUtils.scryRenderedComponentsWithType(root, componentType);
    if (1 !== root.length)
      throw Error(
        "Did not find exactly one match (found: " +
          root.length +
...
for (var eventType$jscomp$inline_11 in eventNameDispatchConfigs)
  ReactTestUtils.Simulate[eventType$jscomp$inline_11] = makeSimulator(
    eventType$jscomp$inline_11
  );
...
var ReactTestUtils$2 = { default: ReactTestUtils },
  ReactTestUtils$3 = (ReactTestUtils$2 && ReactTestUtils) || ReactTestUtils$2;
module.exports = ReactTestUtils$3.default || ReactTestUtils$3;
