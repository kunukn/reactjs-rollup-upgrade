...
function completeUnitOfWork(unitOfWork) {
  ...
  do {
    ...
    if (0 === (workInProgress.effectTag & 1024)) {
          ...
          case 5:
            ...
            if (null !== current && null != current$$1.stateNode)
              ...
              if (popHydrationState(current$$1)) {
                ...
                var type$jscomp$0 = current.type,
                  props = current.memoizedProps;
                type[internalInstanceKey] = current;
                ...
                switch (type) {
                  ...
                  case "select":
                    ...
                    renderExpirationTime$jscomp$0 = _assign({}, newProps, {
                      value: void 0
                    });
                    trapBubbledEvent("invalid", type$jscomp$0);
                    ensureListeningTo(rootContainerInstance, "onChange");
          ...
          case 6:
            if (current && null != current$$1.stateNode)
              ...
              popHydrationState(current$$1)
                ? ((renderExpirationTime$jscomp$0 = current$$1.stateNode),
                  (current = current$$1.memoizedProps),
                  (renderExpirationTime$jscomp$0[
                    internalInstanceKey
                  ] = current$$1),
                  renderExpirationTime$jscomp$0.nodeValue !== current &&
                    markUpdate(current$$1))
                : ((renderExpirationTime$jscomp$0 = current$$1),
                  ...
                  (current[internalInstanceKey] = current$$1),
                  (renderExpirationTime$jscomp$0.stateNode = current));
            }
            break;
          case 11:
            break;
          ...
          case 19:
            ...
            if (null === type$jscomp$0)
              if (type) cutOffTailIfNeeded(newProps, !1);
                ...
                if (
                  ...
                  for (current = current$$1.child; null !== current; ) {
                    type$jscomp$0 = findFirstSuspended(current);
                    if (null !== type$jscomp$0) {
                      current$$1.effectTag |= 64;
                      cutOffTailIfNeeded(newProps, !1);
                      current = type$jscomp$0.updateQueue;
                      null !== current &&
                      ...
                      for (current = current$$1.child; null !== current; )
                        (newProps = current),
                          ...
                          (type$jscomp$0 = newProps.alternate),
                          null === type$jscomp$0
                            ...
                            : ((newProps.childExpirationTime =
                              ...
                              (newProps.expirationTime =
                                type$jscomp$0.expirationTime),
                              (newProps.child = type$jscomp$0.child),
                              (newProps.memoizedProps =
                                type$jscomp$0.memoizedProps),
                              (newProps.memoizedState =
                                type$jscomp$0.memoizedState),
                              (newProps.updateQueue =
                                type$jscomp$0.updateQueue),
                              (type = type$jscomp$0.dependencies),
              ...
              newProps.isBackwards
                ? ((type$jscomp$0.sibling = current$$1.child),
                  (current$$1.child = type$jscomp$0))
                : ((renderExpirationTime$jscomp$0 = newProps.last),
                  null !== renderExpirationTime$jscomp$0
                    ? (renderExpirationTime$jscomp$0.sibling = type$jscomp$0)
                    : (current$$1.child = type$jscomp$0),
      ...
      renderExpirationTime$jscomp$0 = workInProgress;
      if (
        1 === renderExpirationTime ||
        1 !== renderExpirationTime$jscomp$0.childExpirationTime
      ) {
        current = 0;
        for (
          newProps = renderExpirationTime$jscomp$0.child;
          null !== newProps;

        )
          (type = newProps.expirationTime),
            (type$jscomp$0 = newProps.childExpirationTime),
            type > current && (current = type),
            type$jscomp$0 > current && (current = type$jscomp$0),
            (newProps = newProps.sibling);
        renderExpirationTime$jscomp$0.childExpirationTime = current;
      }
