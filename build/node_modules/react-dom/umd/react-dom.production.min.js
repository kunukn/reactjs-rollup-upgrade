...
(function(global, factory) {
        ...
        if (null !== instance)
          a: for (current = instance; ; ) {
            if (5 === current.tag)
              ...
              current.stateNode.nodeValue = newProps
                ? ""
        ...
        a: {
          ...
          switch (current.tag) {
            ...
            case 0:
              break;
            case 1:
              isContextProvider(current.type) &&
                (pop(didPerformWorkStackCursor), pop(contextStackCursor));
              break;
            case 3:
              popHostContainer();
            ...
            case 5:
              ...
              if (null !== current$jscomp$0 && null != current.stateNode)
                ...
                if (popHydrationState(current)) {
                  ...
                  newProps = current$jscomp$0.stateNode;
                  var type = current$jscomp$0.type;
                  rootContainerInstance = current$jscomp$0.memoizedProps;
                  newProps[internalInstanceKey] = current$jscomp$0;
                  newProps[internalEventHandlersKey] = rootContainerInstance;
                  ...
                  switch (type) {
                    ...
                    case "audio":
                      for (var i = 0; i < mediaEventTypes.length; i++)
                        trapBubbledEvent(mediaEventTypes[i], newProps);
                      break;
                    case "source":
                    ...
                    case "details":
                      ...
                      break;
                    case "input":
                      initWrapperState(newProps, rootContainerInstance);
                    ...
                    case "select":
                      newProps._wrapperState = {
                        wasMultiple: !!rootContainerInstance.multiple
                      };
                      trapBubbledEvent("invalid", newProps);
                      ensureListeningTo(
                        rootContainerInstance$jscomp$0,
                      ...
                      break;
                    case "textarea":
                      initWrapperState$2(newProps, rootContainerInstance),
                        trapBubbledEvent("invalid", newProps),
                        ensureListeningTo(
                          rootContainerInstance$jscomp$0,
                          "onChange"
                  ...
                  i = null;
                  for (renderExpirationTime in rootContainerInstance)
                    rootContainerInstance.hasOwnProperty(
                      renderExpirationTime
                    ) &&
                      ((currentHostContext =
                        rootContainerInstance[renderExpirationTime]),
                      "children" === renderExpirationTime
                        ? "string" === typeof currentHostContext
                          ? newProps.textContent !== currentHostContext &&
                  ...
                  switch (type) {
                    case "input":
                      track(newProps);
                      postMountWrapper(newProps, rootContainerInstance, !0);
                      break;
                    case "textarea":
                      track(newProps);
                      renderExpirationTime = newProps.textContent;
                      renderExpirationTime ===
                        newProps._wrapperState.initialValue &&
                        (newProps.value = renderExpirationTime);
                      break;
                    case "select":
                    case "option":
                      break;
                  ...
                  "http://www.w3.org/1999/xhtml" === currentHostContext &&
                  ...
                  rootContainerInstance$jscomp$0 = i;
                  rootContainerInstance$jscomp$0[internalInstanceKey] = type;
                  rootContainerInstance$jscomp$0[
                  ...
                  switch (renderExpirationTime) {
                    ...
                    case "textarea":
                      track(type);
                      rootContainerInstance = type.textContent;
                      rootContainerInstance ===
                        type._wrapperState.initialValue &&
                        (type.value = rootContainerInstance);
                      break;
                    case "option":
                      null != newProps.value &&
                        type.setAttribute(
                    ...
                    case "select":
                      rootContainerInstance = newProps;
                      type.multiple = !!rootContainerInstance.multiple;
                      rootContainerInstance$jscomp$0 =
                        rootContainerInstance.value;
                      null != rootContainerInstance$jscomp$0
                        ? updateOptions(
                            type,
                            !!rootContainerInstance.multiple,
                            rootContainerInstance$jscomp$0,
                            !1
                          )
                        : null != rootContainerInstance.defaultValue &&
                          updateOptions(
                            type,
                            !!rootContainerInstance.multiple,
                            rootContainerInstance.defaultValue,
                            !0
                          );
                      break;
                    default:
              ...
              if (current$jscomp$0 && null != current.stateNode)
                ...
                popHydrationState(current)
                  ? ((current$jscomp$0 = current.stateNode),
                    ...
                    (current$jscomp$0[internalInstanceKey] = current),
                    current$jscomp$0.nodeValue !== renderExpirationTime &&
                      (current.effectTag |= 4))
                  : ((current$jscomp$0 = current),
                    ...
                    (renderExpirationTime[internalInstanceKey] = current),
              ...
              switch (effectTag.tag) {
                ...
                case 5:
                  ...
                  null === current$jscomp$1 &&
                    ...
                    ((current$jscomp$0 = _instance2),
                    shouldAutoFocusHostComponent(
                      effectTag.type,
                      effectTag.memoizedProps
                    ) && current$jscomp$0.focus());
                  break;
                case 6:
                  break;
                case 4:
  ...
  var eventPluginOrder = null,
    ...
    invokeGuardedCallbackImpl$1 = function(
      name,
      func,
      context,
      a,
        ...
        a: {
          ...
          if (null !== getDerivedStateFromProps)
            if (
              ...
              for (
                context = workInProgress.child,
                  null !== context && (context.return = workInProgress);
                null !== context;

              ) {
                var list = context.dependencies;
                if (null !== list) {
                  getDerivedStateFromProps = context.child;
                  for (
                    ...
                    if (
                      ...
                      1 === context.tag &&
                        ...
                        enqueueUpdate(context, dependency));
                  ...
                  getDerivedStateFromProps =
                    10 === context.tag
                      ? context.type === workInProgress.type
                        ? null
                        : context.child
                      : context.child;
                if (null !== getDerivedStateFromProps)
                  getDerivedStateFromProps.return = context;
                else
                  for (
                    ...
                    if (null !== context) {
                      context.return = getDerivedStateFromProps.return;
                      getDerivedStateFromProps = context;
                      break;
                    }
  ...
  var ReactDOM$1 = { default: ReactDOM },
    ReactDOM$2 = (ReactDOM$1 && ReactDOM$1["default"]) || ReactDOM$1;
  return ReactDOM$2.default || ReactDOM$2;
});
