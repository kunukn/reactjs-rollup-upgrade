...
(function(global, factory) {
          ...
          if (popHydrationState(workInProgress)) {
            ...
            switch (type) {
              ...
              case "textarea":
                ...
                renderExpirationTime === newProps._wrapperState.initialValue &&
            ...
            switch (type) {
              ...
              case "audio":
                for (
                  nextProp = 0;
                  nextProp < mediaEventTypes.length;
                  nextProp++
                )
                  trapBubbledEvent(mediaEventTypes[nextProp], current);
                nextProp = newProps;
                break;
              case "source":
              ...
              case "select":
                ...
                nextProp = _assign({}, newProps, { value: void 0 });
                trapBubbledEvent("invalid", current);
                ensureListeningTo(renderExpirationTime, "onChange");
                break;
              case "textarea":
            ...
            switch (type) {
              ...
              case "textarea":
                track(current);
                renderExpirationTime = current.textContent;
                renderExpirationTime === current._wrapperState.initialValue &&
                  (current.value = renderExpirationTime);
                break;
              case "option":
                null != newProps.value &&
        ...
        if (null === props)
                    ...
                    (type = newProps),
                      ...
                      null === props
                        ...
                        : ((type.childExpirationTime =
                          ...
                          (type.expirationTime = props.expirationTime),
                          (type.child = props.child),
                          (type.memoizedProps = props.memoizedProps),
                          (type.memoizedState = props.memoizedState),
                          (type.updateQueue = props.updateQueue),
                          (current = props.dependencies),
                          (type.dependencies =
                            null === current
                              ? null
                              : {
                          ...
                          (type.selfBaseDuration = props.selfBaseDuration),
                          (type.treeBaseDuration = props.treeBaseDuration)),
          ...
          newProps.isBackwards
            ...
            : ((renderExpirationTime = newProps.last),
              null !== renderExpirationTime
                ? (renderExpirationTime.sibling = props)
                : (workInProgress.child = props),
              (newProps.last = props));
        }
  ...
  function renderRoot(root$jscomp$0, expirationTime, isSync) {
    ...
    if (null !== workInProgress) {
      ...
      __interactionsRef.current = root$jscomp$0.memoizedInteractions;
      if (isSync) {
              ...
              do {
                ...
                if (JSCompiler_temp) {
                  ...
                  returnFiber.has(root) ||
                    ...
                    (sourceFiber = unstable_wrap(sourceFiber)),
  ...
  function performUnitOfWork(unitOfWork) {
    ...
    0 !== (unitOfWork.mode & 8)
      ? ((profilerStartTime = now$1()),
        0 > unitOfWork.actualStartTime &&
          (unitOfWork.actualStartTime = now$1()),
  ...
  function scheduleInteractions(root, expirationTime, interactions) {
    if (0 < interactions.size) {
      ...
      pendingInteractionMap = __subscriberRef.current;
  ...
  function createWorkInProgress(current, pendingProps, expirationTime) {
    ...
    null === expirationTime
      ...
      : ((expirationTime.pendingProps = pendingProps),
        ...
        (expirationTime.actualDuration = 0),
        (expirationTime.actualStartTime = -1));
    ...
    expirationTime.selfBaseDuration = current.selfBaseDuration;
    expirationTime.treeBaseDuration = current.treeBaseDuration;
    return expirationTime;
  }
