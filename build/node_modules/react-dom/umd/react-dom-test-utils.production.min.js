...
(function(global, factory) {
    ...
    return function(domComponentOrNode, nativeEventData) {
      ...
      ReactTestUtils.isDOMComponent(domComponentOrNode)
        ? ((domComponentOrNode = findDOMNode(domComponentOrNode)),
          ...
          dispatchEvent(topLevelType, 1, fakeNativeEvent))
  ...
  var flushPassiveEffects$1 = requireString[11],
    IsThisRendererActing$1 = requireString[12],
    ...
    flushWork =
      enqueueTask ||
      function() {
        for (var didFlushWork = !1; flushPassiveEffects$1(); )
          didFlushWork = !0;
        return didFlushWork;
      },
  ...
  ReactSharedInternals =
    ReactDOM.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events;
  var getInstanceFromNode = ReactSharedInternals[0],
    eventNameDispatchConfigs = ReactSharedInternals[4],
    accumulateTwoPhaseDispatches = ReactSharedInternals[5],
    accumulateDirectDispatches = ReactSharedInternals[6],
    enqueueStateRestore = ReactSharedInternals[7],
    restoreStateIfNeeded = ReactSharedInternals[8],
    dispatchEvent = ReactSharedInternals[9],
    runEventsInBatch = ReactSharedInternals[10],
    ReactTestUtils = {
      ...
      act: function(callback) {
        ...
        IsThisRendererActing$1.current = !0;
        try {
  ...
  (function() {
    ...
    for (var eventType in eventNameDispatchConfigs)
  ...
  ReactSharedInternals =
    ((ReactSharedInternals = { default: ReactTestUtils }), ReactTestUtils) ||
    ReactSharedInternals;
