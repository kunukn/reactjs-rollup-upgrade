...
function X(a){if("Identifier"===a.type)return a.name;if("MemberExpression"!==a.type||a.computed)throw Error("Unsupported node type: "+a.type);var e=X(a.object);a=X(a.property);return e+"."+a}function ha(a){return"MemberExpression"!==a.type||"Identifier"!==a.object.type||"React"!==a.object.name||"Identifier"!==a.property.type||a.computed?a:a.property}
function ka(a,e){var b=ha(a);if("Identifier"!==b.type)return null;switch(b.name){case "useEffect":case "useLayoutEffect":case "useCallback":case "useMemo":return 0;case "useImperativeHandle":return 1;default:if(b===a&&e&&e.additionalHooks){try{var h=X(b)}catch(d){if(/Unsupported node type/.test(d.message))return 0;throw d;}return e.additionalHooks.test(h)?0:-1}return-1}}
...
var na={rules:{"rules-of-hooks":{create:function(a){var e=[],b=[];return{onCodePathSegmentStart:function(a){return b.push(a)},onCodePathSegmentEnd:function(){return b.pop()},onCodePathStart:function(){return e.push(new Map)},onCodePathEnd:function(b,d){function h(a){var d=h.cache,c=d.get(a.id);if(null===c){if(!C.has(a.id)){C.add(a.id);d=!0;c=!1;var n=void 0;try{for(var f=a.prevSegments[Symbol.iterator](),B;!(d=(B=f.next()).done);d=!0)h(B.value)}catch(L){c=!0,n=L}finally{try{d||null==f.return||f.return()}finally{if(c)throw n;
}}}return 0}if(void 0!==c)return c;d.set(a.id,null);if(b.thrownSegments.includes(a))c=0;else if(0===a.prevSegments.length)c=1;else{c=0;f=!0;B=!1;var e=void 0;try{n=a.prevSegments[Symbol.iterator]();for(var k;!(f=(k=n.next()).done);f=!0)c+=h(k.value)}catch(L){B=!0,e=L}finally{try{f||null==n.return||n.return()}finally{if(B)throw e;}}}a.reachable&&0===c?d.delete(a.id):d.set(a.id,c);return c}function l(a){var d=l.cache,c=d.get(a.id);if(null===c){if(!C.has(a.id)){C.add(a.id);d=!0;c=!1;var n=void 0;try{for(var f=
a.nextSegments[Symbol.iterator](),B;!(d=(B=f.next()).done);d=!0)l(B.value)}catch(L){c=!0,n=L}finally{try{d||null==f.return||f.return()}finally{if(c)throw n;}}}return 0}if(void 0!==c)return c;d.set(a.id,null);if(b.thrownSegments.includes(a))c=0;else if(0===a.nextSegments.length)c=1;else{c=0;f=!0;B=!1;var e=void 0;try{n=a.nextSegments[Symbol.iterator]();for(var k;!(f=(k=n.next()).done);f=!0)c+=l(k.value)}catch(L){B=!0,e=L}finally{try{f||null==n.return||n.return()}finally{if(B)throw e;}}}d.set(a.id,
c);return c}function v(a){var d=v.cache,c=d.get(a.id);if(null===c)return Infinity;if(void 0!==c)return c;d.set(a.id,null);if(0===a.prevSegments.length)c=1;else{c=Infinity;var n=!0,f=!1,B=void 0;try{for(var b=a.prevSegments[Symbol.iterator](),e;!(n=(e=b.next()).done);n=!0){var k=v(e.value);k<c&&(c=k)}}catch(oa){f=!0,B=oa}finally{try{n||null==b.return||b.return()}finally{if(f)throw B;}}c+=1}d.set(a.id,c);return c}var k=e.pop();if(0!==k.size){var C=new Set;h.cache=new Map;l.cache=new Map;v.cache=new Map;
var F=l(b.initialSegment),g=ca(d),u=ba(d),x=g?aa(g)||S(g):!1,A=Infinity,m=!0,p=!1,I=void 0;try{for(var t=b.finalSegments[Symbol.iterator](),K;!(m=(K=t.next()).done);m=!0){var W=K.value;if(W.reachable){var R=v(W);R<A&&(A=R)}}}catch(G){p=!0,I=G}finally{try{m||null==t.return||t.return()}finally{if(p)throw I;}}m=!0;p=!1;I=void 0;try{for(var y=k[Symbol.iterator](),P;!(m=(P=y.next()).done);m=!0){var E=P.value,D=E[0],M=E[1];if(D.reachable){var J=0===D.nextSegments.length?A<=v(D):A<v(D),T=h(D)*l(D),H=C.has(D.id);
k=!0;t=!1;K=void 0;try{for(var w=M[Symbol.iterator](),N;!(k=(N=w.next()).done);k=!0){var r=N.value;H&&a.report({node:r,message:'React Hook "'+a.getSource(r)+'" may be executed more than once. Possibly because it is called in a loop. React Hooks must be called in the exact same order in every component render.'});if(x){if(!H&&T!==F){var U='React Hook "'+a.getSource(r)+'" is called conditionally. React Hooks must be called in the exact same order in every component render.'+(J?" Did you accidentally call a React Hook after an early return?":
"");a.report({node:r,message:U})}}else if(!d.parent||"MethodDefinition"!==d.parent.type&&"ClassProperty"!==d.parent.type||d.parent.value!==d)if(g){var O='React Hook "'+a.getSource(r)+'" is called in '+('function "'+a.getSource(g)+'" ')+"which is neither a React function component or a custom React Hook function.";a.report({node:r,message:O})}else if("Program"===d.type){var Q='React Hook "'+a.getSource(r)+'" cannot be called at the top level. React Hooks must be called in a React function component or a custom React Hook function.';
...
"omit"))+w,fix:function(a){return a.replaceText(m,"["+T.join(", ")+"]")}})}}else{var G=null;y.forEach(function(a,e){G||a.references.forEach(function(a){if(!G&&d.has(a.identifier)){for(a=a.from;"function"!==a.type;)a=a.upper;a.block===b&&(G=e)}})});if(G){var ia=V({dependencies:y,declaredDependencies:[],optionalDependencies:E,externalDependencies:new Set,isEffect:!0}).suggestedDependencies;a.report({node:b.parent.callee,message:"React Hook "+x+" contains a call to '"+G+"'. Without a list of dependencies, this can lead to an infinite chain of updates. To fix this, pass ["+
ia.join(", ")+("] as a second argument to the "+x+" Hook."),fix:function(a){return a.insertTextAfter(b,", ["+ia.join(", ")+"]")}})}}}}else"useMemo"!==x&&"useCallback"!==x||a.report({node:b.parent.callee,message:"React Hook "+x+" does nothing when called with only one argument. Did you forget to pass an array of dependencies?"})}}}var h={additionalHooks:a.options&&a.options[0]&&a.options[0].additionalHooks?new RegExp(a.options[0].additionalHooks):void 0},d=new WeakMap,z=new WeakSet,l=new WeakMap,v=
new WeakMap;return{FunctionExpression:b,ArrowFunctionExpression:b}}}}};module.exports=na&&na["default"]||na;
