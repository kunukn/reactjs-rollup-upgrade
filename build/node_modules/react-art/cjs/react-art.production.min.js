...
function unmountHostComponents(
  ...
  for (
    var node = current$$1, currentParentIsValid = !1, currentParentIsContainer;
    ;
        ...
        a: for (current$$1 = instance; ; ) {
          if (5 === current$$1.tag)
            (updatePayload = current$$1.stateNode),
              newProps
                ? updatePayload.hide()
                : ((updatePayload = current$$1.memoizedProps),
                  (null == updatePayload.visible || updatePayload.visible) &&
                    current$$1.stateNode.show());
        ...
        switch (current$$1.tag) {
          ...
          case 5:
            ...
            if (null !== current && null != current$$1.stateNode)
              ...
              current._applyProps(current, newProps);
