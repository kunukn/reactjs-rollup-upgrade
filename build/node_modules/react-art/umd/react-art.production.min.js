  ...
  function completeUnitOfWork(unitOfWork) {
    ...
    do {
      ...
      if (0 === (workInProgress.effectTag & 1024)) {
        a: {
          var instance = void 0;
          var _instance6 = current$jscomp$0;
          ...
          switch (current$jscomp$0.tag) {
            ...
            case 3:
              ...
              renderExpirationTime$jscomp$0 = current$jscomp$0.stateNode;
            ...
            case 5:
              ...
              if (null !== _instance6 && null != current$jscomp$0.stateNode)
                updateHostComponent$1(
                  ...
                  _instance6.ref !== current$jscomp$0.ref &&
                ...
                _instance6 = instance;
                appendAllChildren(_instance6, current$jscomp$0, !1, !1);
                current$jscomp$0.stateNode = _instance6;
              ...
              break;
            case 6:
              if (_instance6 && null != current$jscomp$0.stateNode)
                updateHostText$1(
                  _instance6,
                  current$jscomp$0,
            ...
            case 13:
              ...
              instance = !1;
              null !== _instance6 &&
                ((newProps = _instance6.memoizedState),
                (instance = null !== newProps),
                renderExpirationTime$jscomp$0 ||
                  null === newProps ||
                  ((newProps = _instance6.child.sibling),
                  null !== newProps &&
            ...
            case 19:
              ...
              if (null === type)
                if (newProps) cutOffTailIfNeeded(instance, !1);
                  ...
                  if (
                    ...
                    for (
                      _instance6 = current$jscomp$0.child;
                      null !== _instance6;

                    ) {
                      type = findFirstSuspended(_instance6);
                      if (null !== type) {
                        current$jscomp$0.effectTag |= 64;
                        cutOffTailIfNeeded(instance, !1);
                        _instance6 = type.updateQueue;
                        null !== _instance6 &&
                          ((current$jscomp$0.updateQueue = _instance6),
                          (current$jscomp$0.effectTag |= 4));
                ...
                if (!newProps)
                  if (
                    ((_instance6 = findFirstSuspended(type)),
                    null !== _instance6)
                  ) {
                    if (
                      ((current$jscomp$0.effectTag |= 64),
                ...
                instance.isBackwards
                  ...
                  : ((_instance6 = instance.last),
                    null !== _instance6
                      ? (_instance6.sibling = type)
                      : (current$jscomp$0.child = type),
                    (instance.last = type));
              }
              if (null !== instance.tail) {
                ...
                _instance6 = instance.tail;
                instance.rendering = _instance6;
                instance.tail = _instance6.sibling;
        ...
        if (
          ...
          for (instance = _instance6.child; null !== instance; )
