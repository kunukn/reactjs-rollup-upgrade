...
c){k=!0;c=e;d=f;break}if(g===d){k=!0;d=e;c=f;break}g=g.sibling}if(!k)throw h(Error(189));}}if(c.alternate!==d)throw h(Error(190));}if(3!==c.tag)throw h(Error(188));return c.stateNode.current===c?b:a}exports.findCurrentFiberUsingSlowPath=p;
...
exports.findCurrentHostFiberWithNoPortals=function(b){b=p(b);if(!b)return null;for(var a=b;;){if(5===a.tag||6===a.tag)return a;if(a.child&&4!==a.tag)a.child.return=a,a=a.child;else{if(a===b)break;for(;!a.sibling;){if(!a.return||a.return===b)return null;a=a.return}a.sibling.return=a.return;a=a.sibling}}return null};exports.isFiberMounted=function(b){return 2===m(b)};exports.isMounted=function(b){return(b=b._reactInternalFiber)?2===m(b):!1};
