...
function pushHostContext(fiber) {
  ...
  context !== rootInstance &&
    (push(contextFiberStackCursor, fiber, fiber),
    push(contextStackCursor$1, rootInstance, fiber));
}
  ...
  switch (current$$1$jscomp$0.tag) {
    ...
    case 4:
      supportsMutation
        ...
        : supportsPersistence && emptyPortalContainer(current$$1$jscomp$0);
  }
}
...
function emptyPortalContainer(current$$1) {
  if (supportsPersistence) {
    current$$1 = current$$1.stateNode.containerInfo;
    var emptyChildSet = createContainerChildSet(current$$1);
    replaceContainerChildren(current$$1, emptyChildSet);
  }
}
          ...
          case 5:
            ...
            if (null !== current && null != current$$1.stateNode)
              ...
              if (popHydrationState(current$$1)) {
                ...
                newProps.updateQueue = current;
                null !== current && markUpdate(current$$1);
              } else {
                ...
                if (
                  ...
                  for (current = current$$1.child; null !== current; ) {
                    ...
                    if (null !== _instance6) {
                      ...
                      current = _instance6.updateQueue;
                      null !== current &&
                        ...
                        (newProps = renderExpirationTime$jscomp$0),
                          ...
                          null === _instance6
                            ...
                            : ((newProps.childExpirationTime =
                              ...
                              (newProps.child = _instance6.child),
                              (newProps.memoizedProps =
                                _instance6.memoizedProps),
                              (newProps.memoizedState =
                                _instance6.memoizedState),
                              (newProps.updateQueue = _instance6.updateQueue),
      ...
      if (1 === renderExpirationTime || 1 !== current.childExpirationTime) {
        ...
        for (newProps = current.child; null !== newProps; )
          (type = newProps.expirationTime),
            (_instance6 = newProps.childExpirationTime),
            type > renderExpirationTime$jscomp$0 &&
              (renderExpirationTime$jscomp$0 = type),
            _instance6 > renderExpirationTime$jscomp$0 &&
              (renderExpirationTime$jscomp$0 = _instance6),
