...
"use strict";
var ReactFreshBabelPlugin$1 = {
    default: function(babel) {
            ...
            if (
              ...
              switch (argsPath.type) {
                ...
                case "CallExpression":
                  ...
                  if ("Import" === calleeType) return !1;
                  if ("Identifier" === calleeType) {
                    if (
                      0 === node.name.indexOf("require") ||
                      0 === node.name.indexOf("import")
                    )
                      return !1;
                  } else if ("MemberExpression" !== calleeType) return !1;
                  break;
      ...
      if ("function" === typeof babel.getEnv) {
        var env = babel.getEnv();
        if ("development" !== env && "function" !== typeof expect)
          throw Error(
        ...
        visitor: {
          ExportDefaultDeclaration: function(path) {
            ...
            if (
              ...
              findInnerComponents("%default%", declPath, function(
                persistentID,
                targetExpr,
                targetPath
              ) {
            ...
            enter: function(path) {
              ...
              null !== id &&
                ...
                isComponentishName(id) &&
                  !seenForRegistration.has(node) &&
                  (seenForRegistration.add(node),
                  findInnerComponents(id, path, function(
                    persistentID,
                    targetExpr
                  ) {
                    persistentID = createRegistration(
          ...
          VariableDeclaration: function(path) {
            ...
            if (
              ...
              var declPath = path[0];
              findInnerComponents(declPath.node.id.name, declPath, function(
                persistentID,
                targetExpr,
                targetPath
              ) {
                null !== targetPath &&
                  ...
                  ("ArrowFunctionExpression" !== targetExpr.type &&
                    "FunctionExpression" !== targetExpr.type) ||
              ...
              if (void 0 !== registrations) {
                ...
                if (!seenForOutro.has(node)) {
                  ...
                  registrations.forEach(function(_ref) {
                    ...
                    _ref = _ref.persistentID;
                    path.pushContainer(
                      "body",
                      t.expressionStatement(
                        t.callExpression(t.identifier("$RefreshReg$"), [
                          handle,
                          t.stringLiteral(_ref)
                        ])
                      )
                    );
  ...
  ReactFreshBabelPlugin$2 =
    (ReactFreshBabelPlugin$1 && ReactFreshBabelPlugin$1["default"]) ||
    ReactFreshBabelPlugin$1;
module.exports = ReactFreshBabelPlugin$2.default || ReactFreshBabelPlugin$2;
