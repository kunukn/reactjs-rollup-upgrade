...
(function(global, factory) {
  ...
  var isGlobalFocusVisible = !0,
    ...
    FocusResponder = React.unstable_createResponder("Focus", {
          ...
          switch (type) {
            ...
            case "blur":
              state.isFocused &&
                ...
                (state.isFocusVisible = isGlobalFocusVisible),
                (state.isFocused = !1)),
                null == event.nativeEvent.relatedTarget &&
                  (state.pointerType = ""),
                (state.isEmulatingMouseEvents = !1);
          }
      },
    ...
    FocusWithinResponder = React.unstable_createResponder("FocusWithin", {
      targetEventTypes: targetEventTypes,
      rootEventTypes: rootEventTypes,
      getInitialState: function() {
        return {
  ...
  return (
    ...
    targetEventTypes["default"]) || targetEventTypes
  );
});
