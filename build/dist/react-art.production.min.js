...
(function(global, factory) {
  ...
  function completeUnitOfWork(unitOfWork) {
    ...
    do {
      ...
      if (0 === (workInProgress.effectTag & 1024)) {
        a: {
          var current$jscomp$1 = current$jscomp$0;
          ...
          switch (current$jscomp$0.tag) {
            ...
            case 3:
              ...
              pop(didPerformWorkStackCursor);
              pop(contextStackCursor);
              renderExpirationTime = current$jscomp$0.stateNode;
              renderExpirationTime.pendingContext &&
                ((renderExpirationTime.context =
                  renderExpirationTime.pendingContext),
                (renderExpirationTime.pendingContext = null));
              if (null === current$jscomp$1 || null === current$jscomp$1.child)
                current$jscomp$0.effectTag &= -3;
            ...
            case 5:
              ...
              renderExpirationTime = current$jscomp$0.type;
              if (
                ...
                updateHostComponent$1(
                  ...
                  current$jscomp$1.ref !== current$jscomp$0.ref &&
                    (current$jscomp$0.effectTag |= 128);
              else if (newProps) {
                requiredContext(contextStackCursor$1.current);
                current$jscomp$1 = void 0;
                switch (renderExpirationTime) {
                  case TYPES.CLIPPING_RECTANGLE:
                    current$jscomp$1 = current.ClippingRectangle();
                    current$jscomp$1._applyProps = applyClippingRectangleProps;
                    break;
                  case TYPES.GROUP:
                    current$jscomp$1 = current.Group();
                    current$jscomp$1._applyProps = applyGroupProps;
                    break;
                  case TYPES.SHAPE:
                    current$jscomp$1 = current.Shape();
                    current$jscomp$1._applyProps = applyShapeProps;
                    break;
                  case TYPES.TEXT:
                    (current$jscomp$1 = current.Text(
                      newProps.children,
                      newProps.font,
                      newProps.alignment,
                      newProps.path
                    )),
                      (current$jscomp$1._applyProps = applyTextProps);
                }
                if (!current$jscomp$1)
                  throw ReactErrorProd(Error(217), renderExpirationTime);
                current$jscomp$1._applyProps(current$jscomp$1, newProps);
                appendAllChildren(current$jscomp$1, current$jscomp$0, !1, !1);
                current$jscomp$0.stateNode = current$jscomp$1;
              ...
              break;
            case 6:
              if (current$jscomp$1 && null != current$jscomp$0.stateNode)
                updateHostText$1(
                  current$jscomp$1,
                  current$jscomp$0,
            ...
            case 13:
              pop(suspenseStackCursor);
              newProps = current$jscomp$0.memoizedState;
              if (0 !== (current$jscomp$0.effectTag & 64)) {
                current$jscomp$0.expirationTime = renderExpirationTime;
                break a;
              }
              ...
              if (
                null !== current$jscomp$1 &&
                ((rootContainerInstance = current$jscomp$1.memoizedState),
                (newProps = null !== rootContainerInstance),
                !renderExpirationTime &&
                  null !== rootContainerInstance &&
                  ((rootContainerInstance = current$jscomp$1.child.sibling),
                  null !== rootContainerInstance))
              ) {
                var first = current$jscomp$0.firstEffect;
                null !== first
                  ? ((current$jscomp$0.firstEffect = rootContainerInstance),
                    (rootContainerInstance.nextEffect = first))
                  : ((current$jscomp$0.firstEffect = current$jscomp$0.lastEffect = rootContainerInstance),
              ...
              if (renderExpirationTime || newProps)
            ...
            case 19:
              ...
              rootContainerInstance = 0 !== (current$jscomp$0.effectTag & 64);
              ...
              if (null === first)
                if (rootContainerInstance) cutOffTailIfNeeded(newProps, !1);
                  ...
                  if (
                    workInProgressRootExitStatus !== RootIncomplete ||
                    (null !== current$jscomp$1 &&
                      0 !== (current$jscomp$1.effectTag & 64))
                  )
                    for (
                      current$jscomp$1 = current$jscomp$0.child;
                      null !== current$jscomp$1;

                    ) {
                      first = findFirstSuspended(current$jscomp$1);
                      if (null !== first) {
                        current$jscomp$0.effectTag |= 64;
                        cutOffTailIfNeeded(newProps, !1);
                        current$jscomp$1 = first.updateQueue;
                        null !== current$jscomp$1 &&
                          ((current$jscomp$0.updateQueue = current$jscomp$1),
                          (current$jscomp$0.effectTag |= 4));
                        current$jscomp$0.firstEffect = current$jscomp$0.lastEffect = null;
                        current$jscomp$1 = renderExpirationTime;
                        for (
                          renderExpirationTime = current$jscomp$0.child;
                          null !== renderExpirationTime;

                        )
                          (newProps = renderExpirationTime),
                            (rootContainerInstance = current$jscomp$1),
                      ...
                      current$jscomp$1 = current$jscomp$1.sibling;
                    }
                }
              else {
                if (!rootContainerInstance)
                  if (
                    ((current$jscomp$1 = findFirstSuspended(first)),
                    null !== current$jscomp$1)
                  ) {
                    if (
                      ((current$jscomp$0.effectTag |= 64),
                      ...
                      current$jscomp$1 = current$jscomp$1.updateQueue;
                      null !== current$jscomp$1 &&
                        ((current$jscomp$0.updateQueue = current$jscomp$1),
                        (current$jscomp$0.effectTag |= 4));
                ...
                newProps.isBackwards
                  ? ((first.sibling = current$jscomp$0.child),
                    (current$jscomp$0.child = first))
                  : ((current$jscomp$1 = newProps.last),
                    null !== current$jscomp$1
                      ? (current$jscomp$1.sibling = first)
                      : (current$jscomp$0.child = first),
                    (newProps.last = first));
              }
              if (null !== newProps.tail) {
                ...
                current$jscomp$1 = newProps.tail;
                newProps.rendering = current$jscomp$1;
                newProps.tail = current$jscomp$1.sibling;
                newProps.lastEffect = current$jscomp$0.lastEffect;
                current$jscomp$1.sibling = null;
                current$jscomp$0 = suspenseStackCursor.current;
                current$jscomp$0 = rootContainerInstance
                  ? (current$jscomp$0 & 1) | 2
                  : current$jscomp$0 & 1;
                push(suspenseStackCursor, current$jscomp$0);
                current$jscomp$0 = current$jscomp$1;
                break a;
              }
              break;
            case 20:
        ...
        if (
          ...
          for (
            ...
            (newProps = renderExpirationTime.expirationTime),
              ...
              newProps > current$jscomp$1 && (current$jscomp$1 = newProps),
              rootContainerInstance > current$jscomp$1 &&
                (current$jscomp$1 = rootContainerInstance),
              (renderExpirationTime = renderExpirationTime.sibling);
          workInProgress.childExpirationTime = current$jscomp$1;
        }
        ...
        current$jscomp$0 = unwindWork(workInProgress);
        if (null !== current$jscomp$0)
          return (current$jscomp$0.effectTag &= 1023), current$jscomp$0;
        null !== unitOfWork &&
  ...
  function updateContainer(element, container, parentComponent, callback) {
    ...
    scheduleWork(currentTime, current);
    return current;
  }
  ...
  var MAYBE_ITERATOR_SYMBOL = "function" === typeof Symbol && Symbol.iterator,
    ...
    Scheduler_now = _ReactInternals$Sched.unstable_now,
  ...
  var color$jscomp$0 = Color,
    ...
    Base = _class(node, {
      ...
      stroke: function(color$1, width, cap, join, dash) {
        this._stroke = color$1 ? new color$jscomp$0(color$1).toString() : null;
  ...
  var shape = _class(Base, {
      ...
      draw: function(path, width, height) {
        path instanceof path$1 || (path = new path$1(path));
        this.path = path;
    ...
    clippingrectangle = _class(node, container, {
      ...
      renderLayerTo: function(context, xx, yx, xy, yy, x, y) {
        ...
        context.clip();
        for (var node = this.firstChild; node; )
  ...
  var path$2 = VMLPath,
    ...
    node$1 = _class(shadow, transform, {
    ...
    base$1 = _class(node$1, {
      ...
      _createGradient: function(style, stops) {
        ...
        var colors = [],
          color1,
          color2;
        style = function(offset, color$1) {
          color$1 = color$jscomp$0.detach(color$1);
          null == color1 ? (color1 = color2 = color$1) : (color2 = color$1);
    ...
    shape$1 = _class(base$1, {
      ...
      draw: function(path, width, height) {
        path instanceof path$2 || (path = new path$2(path));
    ...
    group$1 = _class(node$1, container, {
      element_initialize: node$1.prototype.initialize,
      initialize: function(width, height) {
    ...
    clippingrectangle$1 = _class(node$1, container, {
      element_initialize: node$1.prototype.initialize,
      initialize: function(width, height) {
    ...
    fontAnchors$1 = { start: "left", middle: "center", end: "right" },
    text$1 = _class(base$1, {
      base_initialize: base$1.prototype.initialize,
      initialize: function(text, font, alignment, path) {
        this.base_initialize("shape");
        var p = (this.pathElement = dom.createElement("path"));
  ...
  return (ReactART && ReactART["default"]) || ReactART;
});
