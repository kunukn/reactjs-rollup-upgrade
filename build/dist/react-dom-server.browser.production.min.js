...
(function(global, factory) {
  ...
  function processContext(type, context, threadID, isClass) {
    ...
    if ((type = type.contextTypes)) {
      threadID = {};
      for (var contextName in type)
        threadID[contextName] = context[contextName];
      context = threadID;
  ...
  function escapeTextForBrowser(text) {
    ...
    if (match) {
      ...
      text =
        lastIndex !== index ? html + text.substring(lastIndex, index) : html;
    }
    return text;
  }
  function createMarkupForProperty(name, value) {
    ...
    if (null !== propertyInfo) {
      ...
      if (3 === JSCompiler_temp || (4 === JSCompiler_temp && !0 === value))
        return name + '=""';
      propertyInfo.sanitizeURL && (value = "" + value);
    ...
    function processChild(element, Component) {
      ...
      if (isClass) {
        if (
          ...
          null != partialState &&
            (isClass.state = _assign({}, isClass.state, partialState));
        }
      } else if (
        ((currentlyRenderingComponent = {}),
          ...
          if (oldReplace && 1 === updater.length) isClass.state = updater[0];
            ...
            for (
              ...
              null != partial &&
                (dontMutate
                  ? ((dontMutate = !1),
                    (partialState = _assign({}, partialState, partial)))
                  : _assign(partialState, partial));
            }
  ...
  for (
    var emptyObject = {}, nextAvailableThreadIDs = new Uint16Array(16), i = 0;
    15 > i;
    i++
  )
  ...
  var matchHtmlRegExp = /["'&<>]/,
    ...
    Dispatcher = {
      readContext: function(context, observedBits) {
        observedBits = currentThreadID;
        validateContextBounds(context, observedBits);
        return context[observedBits];
      },
  ...
  var uppercasePattern = /([A-Z])/g,
    ...
    ReactDOMServerRenderer = (function() {
      ...
      _proto.popProvider = function(provider) {
        provider = this.contextIndex;
        var context = this.contextStack[provider],
          previousValue = this.contextValueStack[provider];
        this.contextStack[provider] = null;
        this.contextValueStack[provider] = null;
        this.contextIndex--;
        context[this.threadID] = previousValue;
      };
      _proto.clearProviders = function() {
        for (var index = this.contextIndex; 0 <= index; index--)
          this.contextStack[index][this.threadID] = this.contextValueStack[
            index
          ];
      };
            ...
            case REACT_MEMO_TYPE:
              return (
                (child = [
                  React.createElement(
                    elementType.type,
                    _assign({ ref: child.ref }, child.props)
                  )
                ]),
                this.stack.push({
                  type: null,
      ...
      _proto.renderDOM = function(element, context, parentNamespace) {
        ...
        if ("input" === tag)
          props = _assign({ type: void 0 }, props, {
          ...
          (this.currentSelectValue =
            ...
            (props = _assign({}, props, { value: void 0 }));
        else if ("option" === tag) {
          ...
          if (null != textareaChildren) {
            ...
            props = _assign({ selected: void 0, children: void 0 }, props, {
  ...
  hasSymbol = ((i = { default: hasSymbol }), hasSymbol) || i;
