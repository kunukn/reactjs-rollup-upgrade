...
(function(global, factory) {
  ...
  React = ["touchstart", "mousedown"];
  var moveDependencies = ["touchmove", "mousemove"],
  ...
  ReactDOM = ReactDOM.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events;
  React = ReactDOM[3];
  (function(
  ...
  })(ReactDOM[2], ReactDOM[0], ReactDOM[1]);
  return (
    ((ReactDOM = {
      ResponderEventPlugin: ResponderEventPlugin,
      ResponderTouchHistoryStore: ResponderTouchHistoryStore,
      injectEventPluginsByName: React
    }),
