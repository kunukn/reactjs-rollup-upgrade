 ...
 */
'use strict';(function(h,p){"object"===typeof exports&&"undefined"!==typeof module?module.exports=p(require("react-dom"),require("react")):"function"===typeof define&&define.amd?define(["react-dom","react"],p):(h=h||self,h.ReactDOMUnstableNativeDependencies=p(h.ReactDOM,h.React))})(this,function(h,p){function x(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,f=1;f<arguments.length;f++)c+="&args[]="+encodeURIComponent(arguments[f]);a.message="Minified React error #"+
b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}function M(a){var b=a._dispatchListeners,c=a._dispatchInstances;if(Array.isArray(b))throw x(Error(103));a.currentTarget=b?N(c):null;b=b?b(a):null;a.currentTarget=null;a._dispatchListeners=null;a._dispatchInstances=null;return b}function t(a){do a=a.return;while(a&&5!==a.tag);return a?a:null}function O(a,b,c){for(var f=[];a;)f.push(a),a=t(a);for(a=f.length;0<a--;)b(f[a],
"captured",c);for(a=0;a<f.length;a++)b(f[a],"bubbled",c)}function C(a,b){if(null==b)throw x(Error(30));if(null==a)return b;if(Array.isArray(a)){if(Array.isArray(b))return a.push.apply(a,b),a;a.push(b);return a}return Array.isArray(b)?[a].concat(b):[a,b]}function v(a,b,c){Array.isArray(a)?a.forEach(b,c):a&&b.call(c,a)}function P(a,b){var c=a.stateNode;if(!c)return null;var f=Q(c);if(!f)return null;c=f[b];a:switch(b){case "onClick":case "onClickCapture":case "onDoubleClick":case "onDoubleClickCapture":case "onMouseDown":case "onMouseDownCapture":case "onMouseMove":case "onMouseMoveCapture":case "onMouseUp":case "onMouseUpCapture":(f=
...
a}}};h=h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events;p=h[3];(function(a,b,c){Q=a;V=b;N=c})(h[2],h[0],h[1]);return(h={ResponderEventPlugin:I,ResponderTouchHistoryStore:u,injectEventPluginsByName:p},h["default"])||h});
