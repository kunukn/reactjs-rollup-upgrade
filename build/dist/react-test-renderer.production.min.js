...
(function(global, factory) {
    ...
    do {
      ...
      if (0 === (workInProgress.effectTag & 2048)) {
        a: {
          ...
          switch (current$$1.tag) {
            ...
            case 3:
              ...
              _instance5 = current$$1.stateNode;
            ...
            case 5:
              ...
              if (null !== _instance5 && null != current$$1.stateNode)
              ...
              break;
            case 6:
              if (_instance5 && null != current$$1.stateNode)
                updateHostText$1(
                  _instance5,
                  current$$1,
            ...
            case 13:
              ...
              if (
                null !== _instance5 &&
                ((type = _instance5.memoizedState),
                (newProps = null !== type),
                !renderExpirationTime$jscomp$0 &&
                  null !== type &&
                  ((type = _instance5.child.sibling), null !== type))
              ) {
            ...
            case 19:
              ...
              if (null === first)
                if (type) cutOffTailIfNeeded(newProps, !1);
                  ...
                  if (
                    ...
                    for (_instance5 = current$$1.child; null !== _instance5; ) {
                      first = findFirstSuspended(_instance5);
                      if (null !== first) {
                        current$$1.effectTag |= 64;
                        cutOffTailIfNeeded(newProps, !1);
                        _instance5 = first.updateQueue;
                        null !== _instance5 &&
                          ((current$$1.updateQueue = _instance5),
                          (current$$1.effectTag |= 4));
                ...
                if (!type)
                  if (
                    ((_instance5 = findFirstSuspended(first)),
                    null !== _instance5)
                  ) {
                    if (
                      ((current$$1.effectTag |= 64),
                ...
                newProps.isBackwards
                  ...
                  : ((_instance5 = newProps.last),
                    null !== _instance5
                      ? (_instance5.sibling = first)
                      : (current$$1.child = first),
                    (newProps.last = first));
              }
              if (null !== newProps.tail) {
                ...
                _instance5 = newProps.tail;
                newProps.rendering = _instance5;
                newProps.tail = _instance5.sibling;
        ...
        if (
          ...
          for (newProps = _instance5.child; null !== newProps; )
  ...
  var enqueueTask$1 = enqueueTask,
    ...
    JSCompiler_object_inline_createNodeMock_337 = function() {
      return null;
    },
    ...
    ReactTestRendererFiber = {
      ...
      create: function(element, options) {
        var createNodeMock = JSCompiler_object_inline_createNodeMock_337,
          isConcurrent = !1;
