...
(function(global, factory) {
  ...
  function getPublicInstance(inst) {
    switch (inst.tag) {
      case "INSTANCE":
        ...
        return createNodeMock({ type: inst.type, props: inst.props });
      default:
        return inst;
    }
  }
    ...
    switch (finishedWork.tag) {
      ...
      case 5:
        ...
        if (null != current$$1) {
          ...
          null !== updatePayload &&
            ((current$$1.type = type), (current$$1.props = newProps));
        }
        break;
      case 6:
      ...
      case 13:
        ...
        if (null !== current$$1)
          a: for (type = current$$1; ; ) {
            if (5 === type.tag)
              (updatePayload = type.stateNode),
                newProps
                  ? (updatePayload.isHidden = !0)
                  : (type.stateNode.isHidden = !1);
            else if (6 === type.tag)
              type.stateNode.isHidden = newProps ? !0 : !1;
            else if (
              13 === type.tag &&
            ...
            if (type === current$$1) break a;
            for (; null === type.sibling; ) {
              if (null === type.return || type.return === current$$1) break a;
              type = type.return;
            }
  ...
  function completeUnitOfWork(unitOfWork) {
    ...
    do {
      ...
      if (0 === (workInProgress.effectTag & 1024)) {
        a: {
          ...
          switch (current$$1.tag) {
            ...
            case 3:
              ...
              if (null === _instance6 || null === _instance6.child)
            ...
            case 5:
              ...
              if (null !== _instance6 && null != current$$1.stateNode)
              ...
              break;
            case 6:
              if (_instance6 && null != current$$1.stateNode)
                updateHostText$1(
                  _instance6,
                  current$$1,
            ...
            case 13:
              ...
              if (
                null !== _instance6 &&
                ((type = _instance6.memoizedState),
                (newProps = null !== type),
                !renderExpirationTime$jscomp$0 &&
                  null !== type &&
                  ((type = _instance6.child.sibling), null !== type))
              ) {
                var first = current$$1.firstEffect;
                null !== first
                  ? ((current$$1.firstEffect = type), (type.nextEffect = first))
            ...
            case 19:
              ...
              if (null === first)
                if (type) cutOffTailIfNeeded(newProps, !1);
                  ...
                  if (
                    workInProgressRootExitStatus !== RootIncomplete ||
                    (null !== _instance6 && 0 !== (_instance6.effectTag & 64))
                  )
                    for (_instance6 = current$$1.child; null !== _instance6; ) {
                      first = findFirstSuspended(_instance6);
                      if (null !== first) {
                        current$$1.effectTag |= 64;
                        cutOffTailIfNeeded(newProps, !1);
                        _instance6 = first.updateQueue;
                        null !== _instance6 &&
                          ((current$$1.updateQueue = _instance6),
                          (current$$1.effectTag |= 4));
                        current$$1.firstEffect = current$$1.lastEffect = null;
                        _instance6 = renderExpirationTime$jscomp$0;
                        for (
                      ...
                      _instance6 = _instance6.sibling;
                    }
                }
              else {
                if (!type)
                  if (
                    ((_instance6 = findFirstSuspended(first)),
                    null !== _instance6)
                  ) {
                    if (
                      ((current$$1.effectTag |= 64),
                      ...
                      _instance6 = _instance6.updateQueue;
                      null !== _instance6 &&
                        ((current$$1.updateQueue = _instance6),
                        (current$$1.effectTag |= 4));
                ...
                newProps.isBackwards
                  ...
                  : ((_instance6 = newProps.last),
                    null !== _instance6
                      ? (_instance6.sibling = first)
                      : (current$$1.child = first),
                    (newProps.last = first));
              }
              if (null !== newProps.tail) {
                ...
                _instance6 = newProps.tail;
                newProps.rendering = _instance6;
                newProps.tail = _instance6.sibling;
                newProps.lastEffect = current$$1.lastEffect;
                _instance6.sibling = null;
        ...
        _instance6 = workInProgress;
        if (
          1 === renderExpirationTime ||
          1 !== _instance6.childExpirationTime
        ) {
          renderExpirationTime$jscomp$0 = 0;
          for (newProps = _instance6.child; null !== newProps; )
          ...
          _instance6.childExpirationTime = renderExpirationTime$jscomp$0;
        }
                  ...
                  if (null !== _updateQueue) {
                    ...
                    if (null !== current$$1$jscomp$0.child)
                      switch (current$$1$jscomp$0.child.tag) {
                        case 5:
                          alternate = getPublicInstance(
                            current$$1$jscomp$0.child.stateNode
                          );
                          break;
                        case 1:
  ...
  function toTree(node) {
    ...
    switch (node.tag) {
      ...
      case 17:
        return childrenToTree(node.child);
      default:
        throw ReactErrorProd(Error(214), node.tag);
    }
  }
  ...
  var valueStack = [],
    ...
    Scheduler_runWithPriority = Scheduler$1.unstable_runWithPriority,
    ...
    for (
      ...
      if (5 === needsVisibilityToggle.tag || 6 === needsVisibilityToggle.tag) {
        ...
        var child = needsVisibilityToggle.stateNode,
          index = isHidden.children.indexOf(child);
        -1 !== index && isHidden.children.splice(index, 1);
        isHidden.children.push(child);
      } else if (
  ...
  var enqueueTask$1 = enqueueTask,
    IsSomeRendererActing$1 = ReactSharedInternals.IsSomeRendererActing,
    isSchedulerMocked =
      "function" === typeof Scheduler$1.unstable_flushAllWithoutAsserting,
    flushWork =
    ...
    JSCompiler_object_inline_createNodeMock_335 = function() {
      return null;
    },
    ...
    ReactTestRendererFiber = {
      ...
      create: function(element, options) {
        var createNodeMock = JSCompiler_object_inline_createNodeMock_335,
          isConcurrent = !1;
        ...
        var container = {
          ...
          root = createFiberRoot(container, isConcurrent ? 2 : 0, !1, null);
        if (null == root) throw ReactErrorProd(Error(215));
        ...
        element = {
          ...
          unstable_flushSync: function(fn) {
            a: {
              ...
              executionContext |= 1;
              try {
                var JSCompiler_inline_result = runWithPriority(
                  99,
                  fn.bind(null, void 0)
                );
                break a;
  ...
  var ReactTestRenderer = { default: ReactTestRendererFiber },
    ReactTestRenderer$1 =
      (ReactTestRenderer && ReactTestRendererFiber) || ReactTestRenderer;
  return ReactTestRenderer$1.default || ReactTestRenderer$1;
});
