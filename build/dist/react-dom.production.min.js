...
(function(global, factory) {
  ...
  function dispatchDiscreteEvent(topLevelType, eventSystemFlags, nativeEvent) {
    ...
    isInsideEventHandler = !0;
    try {
      discreteUpdatesImpl(fn, topLevelType, eventSystemFlags, nativeEvent);
    } finally {
  ...
  function dispatchEvent(topLevelType, eventSystemFlags, nativeEvent) {
    if (_enabled) {
      eventSystemFlags = getEventTarget(nativeEvent);
      eventSystemFlags = getClosestInstanceFromNode(eventSystemFlags);
      null === eventSystemFlags ||
        "number" !== typeof eventSystemFlags.tag ||
        2 === isFiberMountedImpl(eventSystemFlags) ||
        (eventSystemFlags = null);
      if (callbackBookkeepingPool.length) {
        var instance = callbackBookkeepingPool.pop();
        instance.topLevelType = topLevelType;
        instance.nativeEvent = nativeEvent;
        instance.targetInst = eventSystemFlags;
      ...
      try {
        if (((nativeEvent = topLevelType), isBatchingEventUpdates))
          handleTopLevel(nativeEvent, void 0);
        else {
          isBatchingEventUpdates = !0;
          try {
            batchedEventUpdatesImpl(handleTopLevel, nativeEvent, void 0);
          } finally {
  ...
  function popHydrationState(fiber) {
    ...
    } else fiber = hydrationParentFiber ? getNextHydratable(fiber.stateNode.nextSibling) : null;
    ...
    switch (workInProgress.tag) {
      case 1:
        return (
          ...
          renderExpirationTime & 2048
            ? ((workInProgress.effectTag = (renderExpirationTime & -2049) | 64),
              workInProgress)
            : null
        );
      case 3:
  ...
  function completeUnitOfWork(unitOfWork) {
    ...
    do {
      ...
      if (0 === (workInProgress.effectTag & 1024)) {
        a: {
          ...
          switch (current$$1.tag) {
            ...
            case 5:
              ...
              if (null !== domElement && null != current$$1.stateNode)
                ...
                if (popHydrationState(current$$1)) {
                  renderExpirationTime$jscomp$0 = void 0;
                  textNode = current$$1.stateNode;
                  domElement = current$$1.type;
                  props = current$$1.memoizedProps;
                  textNode[internalInstanceKey] = current$$1;
                  textNode[internalEventHandlersKey] = props;
                  switch (domElement) {
                    case "iframe":
                    case "object":
                    case "embed":
                      trapBubbledEvent("load", textNode);
                      break;
                    case "video":
                    case "audio":
                      for (var i = 0; i < mediaEventTypes.length; i++)
                        trapBubbledEvent(mediaEventTypes[i], textNode);
                      break;
                    case "source":
                      trapBubbledEvent("error", textNode);
                      break;
                    case "img":
                    case "image":
                    case "link":
                      ...
                      break;
                    case "form":
                      trapBubbledEvent("reset", textNode);
                      trapBubbledEvent("submit", textNode);
                      break;
                    case "details":
                      trapBubbledEvent("toggle", textNode);
                      break;
                    case "input":
                      initWrapperState(textNode, props);
                      trapBubbledEvent("invalid", textNode);
                      ensureListeningTo(rootContainerInstance, "onChange");
                      break;
                    case "select":
                      textNode._wrapperState = {
                      ...
                      break;
                    case "textarea":
                      initWrapperState$2(textNode, props),
                        trapBubbledEvent("invalid", textNode),
                        ensureListeningTo(rootContainerInstance, "onChange");
                  }
                  assertValidProps(domElement, props);
                  i = null;
                  for (renderExpirationTime$jscomp$0 in props)
                    if (props.hasOwnProperty(renderExpirationTime$jscomp$0)) {
                      var nextProp = props[renderExpirationTime$jscomp$0];
                      "children" === renderExpirationTime$jscomp$0
                        ? "string" === typeof nextProp
                          ? textNode.textContent !== nextProp &&
                            (i = ["children", nextProp])
                  ...
                  switch (domElement) {
                    case "input":
                      track(textNode);
                      postMountWrapper(textNode, props, !0);
                      break;
                    case "textarea":
                      track(textNode);
                      renderExpirationTime$jscomp$0 = textNode.textContent;
                      renderExpirationTime$jscomp$0 ===
                        textNode._wrapperState.initialValue &&
                        (textNode.value = renderExpirationTime$jscomp$0);
                      break;
                    case "select":
                    case "option":
                      break;
                  ...
                  "http://www.w3.org/1999/xhtml" === props &&
                    (props = getIntrinsicNamespace(
                      renderExpirationTime$jscomp$0
                    ));
                  "http://www.w3.org/1999/xhtml" === props
                    ? "script" === renderExpirationTime$jscomp$0
                      ...
                      : "string" === typeof textNode.is
                        ...
                        : ((domElement = domElement.createElement(
                          ...
                          "select" === renderExpirationTime$jscomp$0 &&
                            ((props = domElement),
                            textNode.multiple
                              ? (props.multiple = !0)
                  ...
                  switch (renderExpirationTime$jscomp$0) {
                    ...
                    case "select":
                      ...
                      props = _assign({}, textNode, { value: void 0 });
                      trapBubbledEvent("invalid", domElement);
                      ensureListeningTo(rootContainerInstance, "onChange");
                      break;
                    case "textarea":
                  ...
                  assertValidProps(renderExpirationTime$jscomp$0, props);
                  i = void 0;
                  ...
                  switch (renderExpirationTime$jscomp$0) {
                    ...
                    case "textarea":
                      track(domElement);
                      rootContainerInstance = domElement.textContent;
                      rootContainerInstance ===
                        domElement._wrapperState.initialValue &&
                        (domElement.value = rootContainerInstance);
                      break;
                    case "option":
                      null != textNode.value &&
              ...
              if (domElement && null != current$$1.stateNode)
                ...
                popHydrationState(current$$1)
                  ? ((textNode = current$$1.stateNode),
                    ...
                    (textNode[internalInstanceKey] = current$$1),
                    textNode.nodeValue !== renderExpirationTime$jscomp$0 &&
                      markUpdate(current$$1))
                  : ((textNode = (9 === renderExpirationTime$jscomp$0.nodeType
                      ? renderExpirationTime$jscomp$0
            ...
            case 13:
              ...
              null === domElement
                ? popHydrationState(current$$1)
                : ((rootContainerInstance = domElement.memoizedState),
                  (renderExpirationTime$jscomp$0 =
              ...
              if (
                ...
                if (
                  (null === domElement &&
                    !0 !==
                      current$$1.memoizedProps.unstable_avoidThisFallback) ||
                  0 !== (suspenseStackCursor.current & 1)
                )
                  workInProgressRootExitStatus === RootIncomplete &&
              ...
              if (textNode || renderExpirationTime$jscomp$0)
            ...
            case 19:
              pop(suspenseStackCursor, current$$1);
              textNode = current$$1.memoizedState;
              if (null === textNode) break;
              rootContainerInstance = 0 !== (current$$1.effectTag & 64);
              props = textNode.rendering;
              if (null === props)
                if (rootContainerInstance) cutOffTailIfNeeded(textNode, !1);
                else {
                  if (
                    workInProgressRootExitStatus !== RootIncomplete ||
                    (null !== domElement && 0 !== (domElement.effectTag & 64))
                  )
                    for (domElement = current$$1.child; null !== domElement; ) {
                      props = findFirstSuspended(domElement);
                      if (null !== props) {
                        current$$1.effectTag |= 64;
                        cutOffTailIfNeeded(textNode, !1);
                        textNode = props.updateQueue;
                        null !== textNode &&
                          ((current$$1.updateQueue = textNode),
                          (current$$1.effectTag |= 4));
                        current$$1.firstEffect = current$$1.lastEffect = null;
                        textNode = renderExpirationTime$jscomp$0;
                        for (
                          ...
                          (rootContainerInstance = renderExpirationTime$jscomp$0),
                            ...
                            (props = rootContainerInstance.alternate),
                            null === props
                              ? ((rootContainerInstance.childExpirationTime = 0),
                                (rootContainerInstance.expirationTime = domElement),
                              ...
                              : ((rootContainerInstance.childExpirationTime =
                                ...
                                (rootContainerInstance.child = props.child),
                                ...
                                (rootContainerInstance.updateQueue =
                                  props.updateQueue),
                                (domElement = props.dependencies),
                                (rootContainerInstance.dependencies =
                                  null === domElement
                                    ? null
                                    : {
                                        expirationTime:
                                          domElement.expirationTime,
                                        firstContext: domElement.firstContext,
                                        responders: domElement.responders
                                      })),
                            (renderExpirationTime$jscomp$0 =
                      ...
                      domElement = domElement.sibling;
                    }
                }
              else {
                if (!rootContainerInstance)
                  if (
                    ((domElement = findFirstSuspended(props)),
                    null !== domElement)
                  ) {
                    if (
                      ((current$$1.effectTag |= 64),
                      (rootContainerInstance = !0),
                      cutOffTailIfNeeded(textNode, !0),
                      null === textNode.tail && "hidden" === textNode.tailMode)
                    ) {
                      renderExpirationTime$jscomp$0 = domElement.updateQueue;
                      null !== renderExpirationTime$jscomp$0 &&
                        ((current$$1.updateQueue = renderExpirationTime$jscomp$0),
                        (current$$1.effectTag |= 4));
                      current$$1 = current$$1.lastEffect = textNode.lastEffect;
                      null !== current$$1 && (current$$1.nextEffect = null);
                      break;
                    }
                  } else
                    now() > textNode.tailExpiration &&
                      ...
                      (current$$1.expirationTime = current$$1.childExpirationTime =
                        renderExpirationTime$jscomp$0 - 1));
                textNode.isBackwards
                  ? ((props.sibling = current$$1.child),
                    (current$$1.child = props))
                  : ((renderExpirationTime$jscomp$0 = textNode.last),
                    null !== renderExpirationTime$jscomp$0
                      ? (renderExpirationTime$jscomp$0.sibling = props)
                      : (current$$1.child = props),
                    (textNode.last = props));
              }
              if (null !== textNode.tail) {
                0 === textNode.tailExpiration &&
                  (textNode.tailExpiration = now() + 500);
                renderExpirationTime$jscomp$0 = textNode.tail;
                textNode.rendering = renderExpirationTime$jscomp$0;
                textNode.tail = renderExpirationTime$jscomp$0.sibling;
                textNode.lastEffect = current$$1.lastEffect;
                renderExpirationTime$jscomp$0.sibling = null;
                textNode = suspenseStackCursor.current;
                textNode = rootContainerInstance
                  ? (textNode & 1) | 2
                  : textNode & 1;
                push(suspenseStackCursor, textNode, current$$1);
        ...
        if (1 === renderExpirationTime || 1 !== textNode.childExpirationTime) {
          ...
          for (
            ...
            (domElement = rootContainerInstance.expirationTime),
              ...
              domElement > renderExpirationTime$jscomp$0 &&
                (renderExpirationTime$jscomp$0 = domElement),
          ...
          textNode.childExpirationTime = renderExpirationTime$jscomp$0;
        }
                ...
                case 1:
                  if (focusedElem.effectTag & 256 && null !== current$$1) {
                    var prevProps = current$$1.memoizedProps,
                      ...
                      instance = focusedElem.stateNode,
  ...
  var canUseTextInputEvent =
    ...
    discreteUpdatesImpl = function(fn, a, b, c) {
      return fn(a, b, c);
    },
  ...
  var ChangeEventPlugin = {
    ...
    EnterLeaveEventPlugin = {
      ...
      extractEvents: function(
        ...
        for (
          eventTypePrefix = nativeEventTarget.length;
          0 < eventTypePrefix--;
  ...
  var SimpleEventPlugin = {
    ...
    _enabled = !0,
    elementListeningSets = new ("function" === typeof WeakMap
      ? WeakMap
      : Map)(),
  ...
  var valueStack = [],
    ...
    requestPaint =
      void 0 !== unstable_requestPaint ? unstable_requestPaint : function() {},
    syncQueue = null,
    immediateQueueCallbackNode = null,
    isFlushingSyncQueue = !1,
  ...
  })(batchedUpdates$1, discreteUpdates$1, flushDiscreteUpdates, function(
    fn,
    a
  ) {
    var prevExecutionContext = executionContext;
  ...
  var ReactDOM = {
    ...
    unstable_createSyncRoot: function(container, options) {
      if (!isValidContainer(container))
        throw ReactErrorProd(Error(299), "unstable_createRoot");
  ...
  return ReactDOM$3.default || ReactDOM$3;
});
